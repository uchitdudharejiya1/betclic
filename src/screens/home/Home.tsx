...
export const Home: React.FC = () => {
  ...
  // Check if banner should be visible (only until July 20th, 2026 UTC)
  const currentDate = new Date();
  const expiryDate = new Date('2026-07-20T23:59:59Z'); // UTC timestamp
  const isBannerVisible = currentDate <= expiryDate;
